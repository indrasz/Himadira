                ...
                <ul class="navbar-nav mx-auto mt-2 mt-lg-0">
                    ...
                    <li class="nav-item me-4 dropdown">
                        <a class="nav-link dropdown-toggle d-flex align-items-center" href="#"
                            data-bs-toggle="dropdown">Informasi
                            <svg class="ms-2 d-lg-block dropdown-icon-drop" width="9" height="6" viewBox="0 0 9 6"
                                fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path d="M8 1L4.5 5L1 1" stroke="#7F8487" stroke-width="2" stroke-linecap="round"
                                    stroke-linejoin="round" />
                            </svg>
                            <svg class="ms-2 d-lg-none dropdown-icon-close" width="9" height="10" viewBox="0 0 9 10"
                                fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path d="M8 1L4.5 5L1 1" stroke="#000957" stroke-width="2" stroke-linecap="round"
                                    stroke-linejoin="round" />
                                <path d="M1 9L4.5 5L8 9" stroke="#000957" stroke-width="2" stroke-linecap="round"
                                    stroke-linejoin="round" />
                            </svg>
                        </a>
                        <ul class="dropdown-menu" style="cursor: pointer">
