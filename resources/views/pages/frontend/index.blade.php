    ...
    <section class="w-100 h-100 pb-5">
        ...
        <div class="container dira-news-section p-md-4 p-2">
            ...
            <div class="carousel mt-4 py-4 justify-content-center align-items-center"
                ...
                data-flickity='{"cellAlign" : "center", "contain": false, "groupCells": false, "wrapAround": true, "pageDots": false, "prevNextButtons": false, "draggable": true, "percentPosition": false}'>
                <!-- Card Container 1 -->


                <div class="padding-custom  mx-md-4 mx-3">
                    <div class="box-border bg-white rounded d-flex flex-column card-preview"
                        style="background-image: linear-gradient(180deg, rgba(54, 54, 54, 0) 7.29%, rgba(0, 0, 0, 0.8) 119.2%), url('images/dummy-image2.png'); background-size: cover; background-position: center; background-repeat: no-repeat;">
    ...
    <section class="w-100 h-100 pb-5">
        ...
        <div class="container dira-intern-section p-3">
            ...
            <div class="carousel mt-4 py-4 justify-content-center align-items-center"
                ...
                <div class="box-border bg-white rounded d-flex flex-column card-intern-preview mx-md-4 mx-0"
                    style="background-image: linear-gradient(180deg, rgba(54, 54, 54, 0) 7.29%, rgba(0, 0, 0, 0.8) 119.2%), url('images/dummy-image2.png'); background-size: cover; background-position: center; background-repeat: no-repeat;">
