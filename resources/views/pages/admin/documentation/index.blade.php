        ...
        <div class="col-12 mt-4">
            <div class="card mb-4">
                <div class="d-flex card-header justify-content-between pb-0 p-3">
                    ...
                    <a href="{{ route('dashboard.documentation.create') }}" class="btn btn-sm px-2 bg-gradient-primary ">
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="carousel " style="background: #ffffff !important;"
                                ...
                                @forelse ($documentation as $key => $item)
                                ...
                                @forelse ($documentation as $key => $item)
                                    <tr>
                                        ...
                                        <td class="align-middle text-center">
                                            <span
                                                class="text-secondary text-xs font-weight-bold">{{ $item->department->name }}</span>
                                        </td>
                                        <td class="align-middle text-center">
                                            <span
                                        ...
                                        <td class="align-middle text-center">
                                            ...
                                            <div class="d-flex gap-2">
                                                <a class="btn btn-link text-dark px-3 mb-0"
                                                    href="{{ route('dashboard.documentation.edit', $item->id) }}"><i
                                                        class="fas fa-pencil-alt text-dark me-2"
                                                        aria-hidden="true"></i>Edit</a>

                                                <form action="{{ route('dashboard.documentation.destroy', $item->id) }}"
                                                    method="POST">
                                                    @method('DELETE')
                                                    @csrf
