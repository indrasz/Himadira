                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <div class="uploader border-2" onclick="$('#filePhoto').click()">
                                    <img class="image-uploader" src="{{ Storage::url($creation->thumbnail) }}"/>
                            ...
                            <div class="col-md-8">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="name" id="name" class="form-control" value="{{ $creation->name ?? '' }}"
                                        placeholder="Nama Karya">
                                </div>

                                <div class="form-group">
                                    <label class="form-control-label" for="category">Category</label>
                                    <input type="text" name="category" id="category" class="form-control" value="{{ $creation->category ?? '' }}"
                                        placeholder="Kategori Karya">
                                </div>

                                <div class="form-group">
                                    <label class="form-control-label" for="url">Link Url</label>
                                    <input type="text" name="url" id="url" class="form-control" value="{{ $creation->url ?? '' }}"
                                        placeholder="Link URL Karya">
                                </div>
                                <div class="form-group">
                                    <label class="form-control-label" for="description">Description</label>
                                    <textarea id="editor" name="description" class="form-control" placeholder="A few words about this Ormawa ...">{{ $creation->description ?? '' }}</textarea>
                                </div>
