                                ...
                                @forelse ($info as $key => $item)
                                    <tr>
                                        ...
                                        <td class="align-middle text-center">
                                            ...
                                            @if ($item->category == 'SMART')
                                                <span class="text-secondary text-xs font-weight-bold">Himadira Pintar</span>
                                            @elseif ($item->category == 'INTERN')
                                                <span class="text-secondary text-xs font-weight-bold">Program Magang</span>
                                            @else
                                                <span class="text-secondary text-xs font-weight-bold">Berita</span>
                                            @endif
                                        </td>
                                        <td class="align-middle text-center">
                                            <span
                                        ...
                                        <td class="align-middle text-center">
                                            ...
                                            <div class="d-flex gap-2">
                                                <a class="btn btn-link text-dark px-3 mb-0"
                                                    href="{{ route('dashboard.info.edit', $item->id) }}"><i
                                                        class="fas fa-pencil-alt text-dark me-2"
                                                        aria-hidden="true"></i>Edit</a>

                                                <form action="{{ route('dashboard.info.destroy', $item->id) }}"
                                                    method="POST">
                                                    @method('DELETE')
                                                    @csrf
