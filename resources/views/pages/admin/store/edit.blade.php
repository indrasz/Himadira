                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <div class="uploader border-2" onclick="$('#filePhoto').click()">
                                    <img class="image-uploader" src="{{ Storage::url($store->thumbnail) }}"/>
                            ...
                            <div class="col-md-8">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="price" id="price" class="form-control" value="{{ $store->price ?? '' }}"
                                        placeholder="Harga Produk">
                                </div>

                                <div class="form-group">
                                    <label class="form-control-label" for="url">Link Url</label>
                                    <input type="text" name="url" id="url" class="form-control" value="{{ $store->url ?? '' }}"
                                        placeholder="Link URL Produk">
                                </div>
                                <div class="form-group">
                                    <label class="form-control-label" for="description">Description</label>
                                    <textarea id="editor" name="description" class="form-control" placeholder="A few words about this Ormawa ...">{{ $store->description ?? '' }}</textarea>
                                </div>
