    ...
    <div class="col-12 mt-4">
        <div class="card mb-4">
            <div class="d-flex card-header justify-content-between pb-0 p-3">
                ...
                <a href="{{ route('dashboard.store.create') }}" class="btn btn-sm px-2 bg-gradient-primary ">
                    add new store
                </a>
            </div>
                                    ...
                                    <td class="align-middle text-center">
                                        ...
                                        <div class="d-flex gap-2">
                                            <a class="btn btn-link text-dark px-3 mb-0"
                                                href="{{ route('dashboard.store.edit', $item->id) }}"><i
                                                    class="fas fa-pencil-alt text-dark me-2"
                                                    aria-hidden="true"></i>Edit</a>

                                            <form action="{{ route('dashboard.store.destroy', $item->id) }}"
                                                method="POST">
                                                @method('DELETE')
                                                @csrf
